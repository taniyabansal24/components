    ...
    <div className="mx-auto px-12 flex flex-col justify-between md:flex-row">
        ...
        <div className="images w-full md:w-3/6 my-12 px-4 flex flex-col justify-between items-center gap-5 md:gap-0 md:flex-row ">
            <div className="img1 w-full h-36 md:w-72 md:h-96 rounded-lg overflow-hidden md:mr-5 my-0  relative ">
                <img src="./tour.jpg" alt="" className="w-full h-full object-cover cursor-pointer transition-transform transform-gpu hover:scale-105" />
            </div>
            <div className="img2 w-full h-36 md:w-72 md:h-96 rounded-lg overflow-hidden md:mr-5 my-0 relative">
                <img src="./cab.jpg" alt="" className="w-full h-full object-cover cursor-pointer transition-transform transform-gpu hover:scale-105"/>
            </div>
            <div className="img3 w-full h-36 md:w-72 md:h-96 rounded-lg overflow-hidden md:mr-5 my-0 relative">
                <img src="./hotels.jpg" alt="" className="w-full h-full object-cover cursor-pointer transition-transform transform-gpu hover:scale-105"/>
            </div>
        </div>
    </div>
  );
